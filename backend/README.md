...
## Project Structure
    ...
    ├── appcreationreviewapp_02_2  # Django project configurations
...
1. Clone this repo and `cd appcreationreviewapp_02_2`
...
2. Clone this repo and `cd appcreationreviewapp_02_2`
